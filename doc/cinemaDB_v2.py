...
def main():
    ...
    # Example search
    print("\nExample search:")
    query = "What is the subject of the books?"
    ...
    for i, (doc, metadata, distance) in enumerate(zip(
        ...
        # Display page number for PDFs
        if metadata['file_type'] == 'pdf':
            print(f"Page: {metadata['page_number']}/{metadata['total_pages']}")
            # print(f"Chunk: {metadata['chunk_id'] + 1}/{metadata['total_chunks_in_page']} (on this page)")
        
        # Display chapter info for EPUBs
            ...
            # print(f"Chunk: {metadata['chunk_id'] + 1}/{metadata['total_chunks_in_chapter']} (in this chapter)")
